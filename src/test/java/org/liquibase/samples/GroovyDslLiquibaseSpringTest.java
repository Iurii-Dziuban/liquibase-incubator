...
@ContextConfiguration(locations = {"classpath:liquibase/groovy/groovy-dsl-application-context.xml"})
public class GroovyDslLiquibaseSpringTest {

    private static final String CHANGE_LOG_FILENAME = "classpath:liquibase/groovy/datasetChangeLog.groovy";
